...
namespace AppTask.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Codigo,Nome")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
                _context.Add(departamento);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Codigo,Nome")] Departamento departamento)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DepartamentoExists(departamento.Codigo)) return NotFound();
                    else throw;
                }
                return RedirectToAction(nameof(Index));
            }
